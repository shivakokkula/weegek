...
export default function Privacy(){
  return (<>
    ...
    <section>
      <h3>Introduction</h3>
      <p>Weegek is committed to protecting your privacy and handling your data transparently and securely. This policy outlines how we collect, use, store, and protect your information when you use our website, products, and services.</p>

      <p>Our Privacy Policy (“Privacy Policy”) is designed to help you understand how we collect, use, and share your personal information and to assist you in exercising the privacy rights available to you.</p>

      <p>We are a data company. Since data is core to the Services that we offer, we aim to be as transparent as possible about how and why we store your data. You can read more about our fundamental beliefs about how data should be used to improve software development in our data manifesto.</p>

      <p>All capitalized terms have their definition in Software’s Terms of Service, unless otherwise noted here.</p>
      ...
      <ul>
        ...
        <li>Our use of tracking cookies</li>
        <li>How we communicate with you</li>
      </ul>

      <h3>Scope</h3>
      <p>This Privacy Policy covers the personal information we collect about you when you use our products or services, or otherwise interact with us, including on our website at www.software.com (“Website”), web applications at app.software.com and our related online and offline offerings (collectively, the “Services”). This policy also explains your choices surrounding how we use your personal information, which include how you can object to certain uses of the information and how you can access and update certain information.</p>

      <h3>What information we collect</h3>
      <p>We collect data to enable us to operate our Services and provide you with the best experiences on our website and using our Services. You provide some of this data to us directly, such as when you register to use our Services, subscribe to a newsletter, or contact us for support. We also receive some of your data by means of how you interact with our Services.</p>

      <p>We classify personal information as any information about one of our Users which could, alone or together with other information, personally identify them or otherwise be reasonably linked or connected with them. Information such as a username, password, email address, name, Internet protocol (IP) address, and profile picture are examples of personal information.</p>

      <p>Personal information does not include aggregated, non-personally identifying information that does not identify an individual or cannot otherwise be reasonably linked or connected with them. We may use such aggregated, non-personally identifying information for research purposes and to operate, analyze, improve, and optimize our Website and Services.</p>

        <h3>Information you provide to us</h3>
      <h4>Account and profile creation</h4>

      <p>We require basic information when you create your account, such as your username and password. You may choose to give us more information for your profile, such as your name, avatar, occupation, company, and location. Additionally, we collect more detailed information about you such as your office type and work hours to help us improve our Services that we provide to you.</p>

      <h4>Payment information</h4>

        <p>When you make purchases in our app, a secure window will be opened directly to our third-party subscription provider (Chargebee Inc.) and any payments will be securely processed through our third-party payment providers (Swipesum, Inc. and We are Network Merchants, LLC).</p>

      <h4>Surveys</h4>

      <p>We may contact you to participate in surveys. If you decide to participate, you may be asked to provide certain information which may include personal information.</p>

        <h3>Information collected automatically</h3>
      <h4>User data</h4>

      <p>When you install one of our plugins—such as Code Time—and sign up for our Services, we collect data required to provide our Services. For instance, our Services measures code time using a combination of events sent by our plugin, such as typing in a file and focusing your code editor. All of our plugins are open-source and available on GitHub.</p>

      <p>Data we collect includes, but is not limited to:</p>

      <ul>
          <li>Coding telemetry</li>
        <li>Keystrokes, lines of code added and deleted, characters added and deleted, file syntax, and project pathnames</li>
        <li>Non-coding telemetry</li>
        <li>Actions that you take, like opening and closing files or focusing and unfocusing your editor</li>
        <li>Location data based on IP addresses and geographic regions</li>
        <li>Interactions with editor UI elements related to Software’s plugins</li>
        <li>Names and version numbers of installed Software plugins</li>
        <li>Source control history</li>
        <li>Logs, including repository metadata, names, contributors, branches, and versioning history, from Git or other source control systems</li>
      </ul>

      <h4>Device information</h4>

      <p>When you visit and interact with any of our Services, we collect data about your device, such as your operating system, hostname, browser type, and referring URLs.</p>

      <h4>Usage data</h4>

      <p>We collect data about how you interact with Software and our Services. For example, we may collect data about the features you use, the web pages you visit, and the plugins you install. This includes your interactions on our website and your interactions with us via email. It also includes interactions you may experience with our Services in your code editor.</p>

      <h4>Cookies and similar technologies information</h4>

      <p>   To your consent, we automatically collect information from cookies and similar technologies (such as cookie ID and settings) to keep you logged in, to remember your preferences, and to identify you and your device.  Please see here for more information about our use of cookies and similar technologies.</p>

      <h4>Information from other sources</h4>

      <p>When you grant us authorization to connect to another service provider, such as Google, we collect data from that tool per the permission scopes requested from you. We may store your data from third-party services for the ease of providing our Services. Examples of data we collect from a Google Calendar integration include the name and ID primary calendar, meeting names, and number of participants.</p>

      <ul>
        <li>Google: calendar information, including calendar name, and event metadata, including event name, start time, end time, and participant count.</li>
        <li>Spotify: song metadata and listening activity, including name, duration, genre, listening start time and end time, and liked songs.</li>
      </ul>
          
      <h3>What information we do not collect</h3>

      <p>We do not read or store code from any User’s repository or try to infer a User’s code from keystroke or editor actions, nor can code be reverse-engineered from the data we collect.</p>
      ...
      <h4>Provide the services or requested information</h4>

      <p>Examples of how we may use your personal information to provide our Services include:</p>

      <ul>
        <li>Creating your account and providing you with our Services;</li>
        <li>Providing you with a paid Subscription or any other paid service you request;</li>
        <li>Identifying you on our Website;</li>
        <li>  Communicating with you via email;</li>
        <li>Responding to support requests;</li>
        <li>Inviting you to take part in surveys, beta programs, or other research projects, subject, where necessary, to your consent.</li>
      </ul>

      <h4>Serve administrative purposes</h4>

      <p>Examples of how we may use your personal information to serve administrative purposes include:</p>

      <ul>
        <li>Better understanding how our Users use Software and to improve our Website and Services;</li>
        <li>Developing new products and services;</li>
        <li>Authenticating and verifying individual identities;</li>
        <li>Investigating possible fraud or attempts to harm Software or our Users;</li>
        <li>Communicating with you about your account, activities on our Services and Privacy Policy changes; and</li>
        <li>Complying with our legal obligations, protecting our intellectual property, and enforcing our Terms of Service.</li>
      </ul>

      <h4>Marketing our products and services</h4>

      <p>We may use personal information to tailor and provide you with content. If you have any questions about our marketing practices or if you would like to opt out of the use of your personal information for marketing purposes, you may update your subscription preferences at any time.</p>
      ...
      <h4>Process information on behalf of our customers</h4>

      <p>We may use personal information to tailor and provide you with content. If you have any questions about our marketing practices or if you would like to opt out of the use of your personal information for marketing purposes, you may update your subscription preferences at any time.</p>

      <h4>De-identified and aggregated information use</h4> 
      <ul>
        <li>We may use personal information and other data about you to create de-identified and/or aggregated information. De-identified and/or aggregated information is not personal information, and we may use and disclose such information in a number of ways, including research, internal analysis, analytics, and any other legally permissible purposes. For example, we may compile anonymized averages on the activity across our Software users to show global reference classes in our Services.</li>
      </ul>

      <h4>Process information on behalf of our customers</h4>
      <ul>
        <li>Our customers may choose to use our Services to process certain data of their own, which may contain personal information. Such personal information that is processed by us on behalf of our customers, and our privacy practices will be governed by the contracts that we have in place with our customers, not this Privacy Policy.</li>
      </ul>
...
<h4>Sharing content with others</h4>
...
<h4>Disclosure in the event of merger, sale, or other asset transfer:</h4>
...
<h4>How we secure your information</h4>
...
<h4>How you can access and control the information we collect</h4>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-EBVZZGVBVZ"></script>
<script async defer src="https://tags.tinypass.com/tinypass.js" type="text/javascript"></script>
<script type="text/javascript">
  TP.tinypass.apiKey = "HJkUjK4qA";
  TP.tinypass.environment = "production";
</script>
</section>
</>
);}